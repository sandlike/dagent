...
TRANSITIONS: dict[tuple[PipelineState, str], PipelineState | None] = {
    ...
    (PipelineState.TEST_PLAN_GENERATION, "task_succeeded"): PipelineState.TEST_PLAN_REVIEW,
    (PipelineState.TEST_PLAN_REVIEW, "approve"): PipelineState.FINAL_ACCEPTANCE,
    (PipelineState.TEST_PLAN_REVIEW, "reject"): PipelineState.TEST_PLAN_GENERATION,
...
WAITING_HUMAN_STATES = {
    ...
    PipelineState.TEST_PLAN_REVIEW,

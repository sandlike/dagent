...
export function defaultProviderConfig(template) {
    const meta = PROVIDER_TEMPLATES.find((t) => t.id === template) ?? PROVIDER_TEMPLATES[0];
    return {
        template,
        apiKey: '',
...
export const PERMISSION_ACTIONS = ['allow', 'ask', 'deny'];
// 预设模式 → 各工具动作
